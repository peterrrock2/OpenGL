   ...
   while(u < 2 * PI + du)
   {
      v = 0.0;
        ...
        while(v < 2 * PI + dv)
        {
          ...
          glTexCoord2f(cx / (0.4 * stretch * divv), cy / (stretch * divu));
          glVertex3d((R + r * cos(u)) * cos(v),
                     (R + r * cos(u)) * sin(v),
                      r * sin(u));


          glNormal3d(-(-r * cos(u + du) * (R + r * cos(u + du)) * cos(v) * pow(r * r * pow(R + r * cos(u + du), 0.2e1), -0.1e1 / 0.2e1)),
                     -(-r * cos(u + du) * (R + r * cos(u + du)) * sin(v) * pow(r * r * pow(R + r * cos(u + du), 0.2e1), -0.1e1 / 0.2e1)),
                     -((-r * sin(u + du) * pow(cos(v), 0.2e1) * (R + r * cos(u + du)) - r * sin(u + du) * pow(sin(v), 0.2e1) * (R + r * cos(u + du))) * pow(r * r * pow(R + r * cos(u + du), 0.2e1), -0.1e1 / 0.2e1)));

          glTexCoord2f(cx / (0.4 * stretch * divv), (cy + 1) / (stretch * divu));
          glVertex3d((R + r * cos(u + du)) * cos(v),
                     (R + r * cos(u + du)) * sin(v),
                      r * sin(u + du));

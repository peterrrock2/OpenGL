...
/*  Makes a fun bracelet of tori that can be moved around
 *  the scene
 */
static void bracelet(double x0,double y0,double z0,
                    double th, double ph,
                    float R, float r, int numrings)
{
  ...
  for(int i = 0; i < numrings; i++)
  {
    ...
    torus(x, y, z, 90, 90 + (360 / numrings) * i, RR, rr);
  }
...
void display()
{
   ...
   //  Draw bracelet
   bracelet(xbraclet, ybraclet, zbraclet,0,0,2,0.5,rings);
